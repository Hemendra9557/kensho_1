...
from pykakasi import kakasi  # Import pykakasi for transliteration
...
# Function to transliterate text to English
def transliterate_to_romaji(text):
    kakasi_instance = kakasi()
    kakasi_instance.setMode("H", "a")  # Hiragana to Romaji
    kakasi_instance.setMode("K", "a")  # Katakana to Romaji
    kakasi_instance.setMode("J", "a")  # Japanese (Kanji) to Romaji
...
def handle_message(text):
    ...
    transliterated_message = unidecode(translated_message)
    # Speak the incoming message
    speak_message(transliterated_message)
